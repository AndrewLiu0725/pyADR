...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.T0S.setToolTip(_translate("MainWindow", "<html><head/><body><p>T0 Statistics:</p><p>Please select all the files (calculated by the <span style=\" font-style:italic;\">Calculate T0 page</span>) for which you want to compute the statistics of the T<span style=\" vertical-align:sub;\">0</span> values.</p></body></html>"))
        ...
        self.MR.setToolTip(_translate("MainWindow", "<html><head/><body><p>Mass Ratio Calculation:</p><p>Please select one mass file first and then one preline file. Both files have to be calculated by <span style=\" font-style:italic;\">Calculate T0 page</span>.</p></body></html>"))
        ...
        self.ARS.setToolTip(_translate("MainWindow", "<html><head/><body><p>Air Ratio Statistics:</p><p>Please select all the files (calculated by the <span style=\" font-style:italic;\">Mass Ratio Page</span>) for which you want to compute the statistics of the air ratios.</p></body></html>"))
        ...
        self.AC.setToolTip(_translate("MainWindow", "<html><head/><body><p>Age Calculation:</p><p>Please select one file (calculated by the <span style=\" font-style:italic;\">Mass Ratio Page</span>) that you want to calculate the age for.</p></body></html>"))
        ...
        self.PS_button.setToolTip(_translate("MainWindow", "<html><head/><body><p><br/></p></body></html>"))
